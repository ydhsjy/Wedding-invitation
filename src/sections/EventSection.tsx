              ...
              <article className="relative mx-auto min-h-[21rem] w-full max-w-[20rem] overflow-hidden rounded-[1.75rem] bg-[#edf5f8] px-5 py-5 text-center text-[#1f3340] shadow-[0_18px_36px_rgba(45,80,100,0.16)] ring-1 ring-[#9bb8c8]/35 sm:max-w-[23rem] sm:px-7 sm:py-6 lg:min-h-[22rem] lg:max-w-[26rem] lg:rounded-[2rem] lg:px-8 lg:py-6">
                <div className="relative z-10 mx-auto flex min-h-[18rem] max-w-[18rem] flex-col items-center justify-start lg:min-h-[19rem] lg:max-w-sm">
                  <Image
                    ...
                    className="mb-2 h-20 w-28 object-contain opacity-85 sm:h-24 sm:w-32 lg:h-16 lg:w-24"
                  />
                  <h3 className="max-w-[18rem] break-words font-serif text-[34px] font-normal uppercase leading-[0.98] tracking-[0.04em] text-[#1f3340] sm:text-[42px] lg:text-[25px]">
                    {event.title}
                  </h3>
                  <div className="mt-3 h-px w-full max-w-[14rem] bg-[#5d8195]/75 sm:max-w-[16rem]" />
                  <div className="mt-4 flex min-h-[9.5rem] flex-col items-center sm:min-h-[10rem] lg:min-h-[5.5rem]">
                    <p className="font-serif text-[18px] leading-7 text-[#27485c] sm:text-[19px] lg:text-[10px] lg:leading-4">{event.date}</p>
                    <p className="mt-3 font-serif text-[18px] leading-7 text-[#27485c] sm:text-[19px] lg:text-[10px] lg:leading-4">{event.time}</p>
                    <p className="mt-3 font-serif text-[18px] font-semibold leading-7 text-[#1f3340] sm:text-[19px] lg:text-[10px] lg:leading-4">{event.venue}</p>
                    <p className="mt-2 max-w-[17rem] font-serif text-[18px] leading-7 text-[#3f5f72] sm:max-w-xs sm:text-[19px] lg:text-[10px] lg:leading-4">{event.address}</p>
                  </div>
                  <a
                    href={event.mapUrl}
                    target="_blank"
