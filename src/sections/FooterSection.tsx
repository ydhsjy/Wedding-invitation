...
export function FooterSection() {
  return (
    <footer className="relative overflow-hidden bg-ink text-ivory">
      ...
      <Container className="relative z-10 py-16 text-center sm:py-24">
        <MotionReveal>
          ...
          <h2 className="couple-name-titlecase mt-10 font-script text-[57px] font-normal leading-none text-ivory sm:text-[71px] lg:text-[36px]">{wedding.coupleNames}</h2>
